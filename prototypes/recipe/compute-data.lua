...
data:extend({
    {   -- Recipe for compute-data produced by small-compute-nodes, input COLD air
        type = 'recipe',
        name = default_vars.mod_prefix .. 'compute-data-cool',
        normal = {
            enabled = false,
            --hidden  = true,
            ...
            results = {
                ...
                {type = 'fluid', name = default_vars.mod_prefix .. 'compute-coolant-air', amount = 5, temperature = 45, fluidbox_index = 3, catalyst_amount = 5}
            }
            energy_required = 5,
        },
    },
